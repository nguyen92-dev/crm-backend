...
public class AppUserFactory {
  ...
  public static AppUserReqDto appUserReqDto() {
    return new AppUserReqDto("testuser", "password123", "test@example.com", "Test User");
  }

  public static AppUserBaseResDto appUserResDto() {
    return new AppUserBaseResDto(1L, "testuser", "test@example.com","fullname",  AppRoles.USER, null);
  }

  public static AppUserUpdateReqDto appUserReqUpdateDto() {
    return new AppUserUpdateReqDto("test@example.com", "fullName", AppRoles.USER);
  }
}
